    ...
    <footer className="bg-white px-4 lg:px-8">
      <div className="mx-auto max-w-7xl border-t border-gray-200 py-8">
        <div className="flex flex-col items-center justify-center gap-4 text-center">
          {/* Company Name */}
          <span className="text-xl font-bold text-[#2b5e8e]">Boyce Property Group</span>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-xs text-gray-500">
            ...
            <span className="text-gray-300">|</span>
            <a href="tel:2093368996" className="transition-colors hover:text-gray-900">
              (209) 336-8996
            </a>
          </div>

          <p className="text-xs text-gray-400">
            &copy; {new Date().getFullYear()} Boyce Property Group. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
