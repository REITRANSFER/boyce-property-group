...
// Service areas by state - specific cities and their surrounding suburbs
const SERVICE_CITIES: Record<string, Set<string>> = {
  CA: new Set([
    // Sacramento metro
    "sacramento", "elk grove", "roseville", "rocklin", "folsom",
    "citrus heights", "rancho cordova", "west sacramento", "davis",
    "woodland", "yuba city", "marysville", "auburn", "loomis",
    "granite bay", "lincoln", "galt", "placerville", "cameron park",
    "el dorado hills", "north highlands", "rio linda", "arden-arcade",
    "fair oaks", "orangevale", "antelope", "gold river",
    "rancho murieta", "shingle springs", "rescue",
    // County names (unincorporated areas)
    "placer", "el dorado", "yolo", "sutter", "yuba",
  ]),
  TN: new Set([
    // Nashville metro
    "nashville", "franklin", "brentwood", "murfreesboro", "smyrna",
    "la vergne", "antioch", "nolensville", "spring hill", "columbia",
    "mt. juliet", "mount juliet", "old hickory", "hermitage", "donelson",
    "bellevue", "goodlettsville", "hendersonville", "gallatin",
    "white house", "madison", "berry hill", "forest hills", "oak hill",
    "thompsons station",
    // County names
    "davidson", "williamson", "rutherford", "wilson", "sumner", "maury",
  ]),
  IN: new Set([
    // Indianapolis metro
    "indianapolis", "carmel", "fishers", "noblesville", "westfield",
    "zionsville", "brownsburg", "avon", "greenwood", "greenfield",
    "plainfield", "mooresville", "beech grove", "speedway", "lawrence",
    "shelbyville", "whitestown", "lebanon",
    // County names
    "marion", "hamilton", "hendricks", "johnson", "hancock", "boone",
  ]),
}
    ...
    if (step === 7) {
      ...
      try {
        const payload = {
          ...surveyData,
          ...trackingRef.current,
          source: 'Boyce Property Group - Direct Response',
    ...
    return (
      <div className="w-full max-w-2xl rounded-2xl border border-gray-200 bg-white p-6 shadow-lg">
        <div className="flex flex-col items-center gap-5 text-center">
          ...
          <a
            href="tel:2093368996"
            className="mt-2 inline-flex items-center gap-2 rounded-xl bg-[#2b5e8e] px-6 py-3 text-white hover:bg-[#1a3d5f] transition-colors"
          >
            Call Us: (209) 336-8996
          </a>
        </div>
      </div>
    )
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Home className="h-5 w-5 text-[#2b5e8e]" />
        ...
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            className="bg-[#2b5e8e] text-white hover:bg-[#1a3d5f] disabled:opacity-50"
          >
            {isSubmitting ? (
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-center pt-2">
              We currently only buy houses in <strong>Georgia, Indiana, Alabama, Tennessee, Mississippi, and Texas</strong>.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="mt-4 flex flex-col gap-3">
            <Button
              ...
              className="w-full bg-[#2b5e8e] text-white hover:bg-[#1a3d5f]"
            >
              Enter a Different Address
            </Button>
            <p className="text-center text-xs text-gray-500">
              If you believe this is an error, please call us at{" "}
              <a href="tel:2093368996" className="font-medium text-[#2b5e8e] hover:underline">
                (209) 336-8996
              </a>
            </p>
          </div>
