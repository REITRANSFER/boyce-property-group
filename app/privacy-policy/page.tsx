...
export const metadata: Metadata = {
  title: "Privacy Policy | Boyce Property Group",
}
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 md:py-16">
        ...
        <div className="mt-8 space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              Personal Information is an important part of our business, and we are not in the business of selling it to others. We share Personal Information only as described below and with affiliates of Boyce Property Group.
            </p>
            <p className="mt-3">
            ...
            <p className="mt-3">
              As we continue to develop our business, we might sell or buy business units. In such transactions, Personal Information generally is one of the transferred business assets. In the event that Boyce Property Group or substantially all of its assets are acquired, Personal Information will be one of the transferred assets.
            </p>
            <p className="mt-3">
              We release Personal Information (a) when we believe release is appropriate to comply with the law, respond to claims or comply with legal process served on Boyce Property Group (e.g., a lawful subpoena, warrant or court order); (b) to enforce or apply our Terms of Service and other agreements; (c) to protect the rights, property, or safety of Boyce Property Group, our Site, our users or others, including preventing fraudulent, abusive, or unlawful use of our Site; or (d) if we reasonably believe that an emergency involving immediate danger of death or serious physical injury to any person requires disclosure of communications or justifies disclosure of records without delay.
            </p>
            <p className="mt-3">
              We may share Personal Information with realtors who are not related to Boyce Property Group for the purpose of facilitating a transaction involving a property submitted through our Site. Such realtors are not subject to this Privacy Policy and Boyce Property Group disclaims any responsibility for such realtors&apos; privacy policies or practices.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p className="mt-3">
              We may provide links to third-party websites as a service to our users, and we are not responsible for the content or information collection practices of those pages. Please note that these websites&apos; privacy policies may differ from those of Boyce Property Group. We encourage you to review and understand their privacy practices before providing them with information.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              If your Personal Information changes or you would like to review the Personal Information we may have on file, please contact us at <a href="tel:2093368996" className="text-[#2b5e8e] hover:underline">(209) 336-8996</a> with the new information or your review request.
            </p>
          </section>
