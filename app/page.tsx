...
export default function BoycePropertyGroupPage() {
  return (
    <main className="relative min-h-screen bg-gray-50">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-center gap-2 bg-white py-2 md:py-4 shadow-sm">
          <Phone className="h-4 w-4 md:h-5 md:w-5 text-[#2b5e8e]" />
          <a
            href="tel:2093368996"
            className="text-base md:text-lg font-semibold text-gray-900 hover:text-[#2b5e8e] transition-colors"
          >
            (209) 336-8996
          </a>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 py-4 md:py-6 lg:px-8">
          ...
          <div className="mx-auto text-center">
            <h1 className="text-2xl font-bold leading-tight text-gray-900 md:text-4xl lg:text-[2.75rem] lg:leading-tight text-balance">
              Homeowners: Get a <span className="text-[#2b5e8e]">Fair Cash Offer</span> in 24 Hours. No Fees. No Repairs. <span className="text-[#16a085]">Close in as Few as 14 Days.</span>
            </h1>
