...
const FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "We buy houses in Sacramento (CA), Nashville (TN), and Indianapolis (IN), including all cities and surrounding suburbs in each metro area. If you're unsure whether we cover your specific address, submit it and we'll let you know right away.",
  },
  {
...
export default function ThankYouPage() {
  ...
  return (
    <main className="relative min-h-screen bg-gray-50">
      {/* Thank You Hero */}
      <div className="bg-gradient-to-b from-[#2b5e8e]/10 to-transparent py-8 md:py-10">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mb-8 overflow-hidden rounded-2xl bg-white shadow-lg">
            <div className="px-6 py-8 md:px-8 md:py-10">
              <p className="text-xs font-semibold uppercase tracking-wider text-[#2b5e8e]">A Personal Note</p>
              <h2 className="mt-2 text-xl font-bold text-gray-900 md:text-2xl">From Brandon Boyce, Founder</h2>
              ...
              <div className="mt-6 space-y-4 text-sm leading-relaxed text-gray-700 md:text-base">
                ...
                <p>
                  I started Boyce Property Group because I kept meeting good people stuck in bad situations. Inherited properties they couldn't afford to keep. Houses that needed more work than they had time or money for. Divorces, job relocations, tax liens... life happens. And when it does, the last thing you need is someone telling you to repaint your kitchen and "list it in the spring."
                </p>
                <p>
                ...
                <p className="font-medium text-gray-900">
                  Talk soon,<br />
                  Brandon Boyce<br />
                  <span className="font-normal text-gray-500">Founder, Boyce Property Group</span>
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white py-12">
        <div className="mx-auto max-w-2xl px-4 text-center">
          ...
          <a
            href="tel:2093368996"
            className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#2b5e8e] px-8 py-3 text-lg font-semibold text-white transition-colors hover:bg-[#1a3d5f]"
          >
